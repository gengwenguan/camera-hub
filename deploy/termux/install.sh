...
CAMERA_HUB_DDNS_CONFIG_FILE='${STATE_DIR}/ddns.json'
CAMERA_HUB_DDNS_STATUS_FILE='${STATE_DIR}/ddns-status.json'
...
grep -q '^CAMERA_HUB_DDNS_CONFIG_FILE=' "${ENV_FILE}" ||
    echo "CAMERA_HUB_DDNS_CONFIG_FILE='${STATE_DIR}/ddns.json'" >> "${ENV_FILE}"
grep -q '^CAMERA_HUB_DDNS_STATUS_FILE=' "${ENV_FILE}" ||
    echo "CAMERA_HUB_DDNS_STATUS_FILE='${STATE_DIR}/ddns-status.json'" >> "${ENV_FILE}"
